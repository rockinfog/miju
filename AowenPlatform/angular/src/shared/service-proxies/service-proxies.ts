...
export class CarServiceProxy {
     ...
     * @return Success
     */
    get(id: number): Observable<CarDto> {
        let url_ = this.baseUrl + "/api/services/app/Car/Get?";
        if (id !== undefined)
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<CarDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<CarDto>><any>Observable.throw(response_);
        });
    }

    protected processGet(response: Response): Observable<CarDto> {
        const status = response.status; 
        ...
        return Observable.of<CarDto>(<any>null);
    }

    /**
     * @return Success
     */
    getAll(skipCount: number, maxResultCount: number): Observable<PagedResultDtoOfCarDto> {
        let url_ = this.baseUrl + "/api/services/app/Car/GetAll?";
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfCarDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfCarDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: Response): Observable<PagedResultDtoOfCarDto> {
        const status = response.status; 
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfCarDto.fromJS(resultData200) : new PagedResultDtoOfCarDto();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<PagedResultDtoOfCarDto>(<any>null);
    }

    /**
     * @return Success
     */
    create(input: CreateCarDto): Observable<CarDto> {
        let url_ = this.baseUrl + "/api/services/app/Car/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: Response): Observable<CarDto> {
        const status = response.status; 
     ...
     * @return Success
     */
    update(input: CarDto): Observable<CarDto> {
        let url_ = this.baseUrl + "/api/services/app/Car/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: Response): Observable<CarDto> {
        const status = response.status; 
    ...
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Car/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
...
export class PagedResultDtoOfCarDto implements IPagedResultDtoOfCarDto {
    totalCount: number;
    items: CarDto[];

    constructor(data?: IPagedResultDtoOfCarDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PagedResultDtoOfCarDto {
        let result = new PagedResultDtoOfCarDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfCarDto {
    totalCount: number;
    items: CarDto[];
}
